...
fn test_add_simple(run: fn(a: u8, b: u8) -> Emulator) {
...
fn test_add_with_carry(run: fn(a: u8, b: u8) -> Emulator) {
    let emulator = run(0xf0, 0x11);
...
fn test_add_with_half_carry(run: fn(a: u8, b: u8) -> Emulator) {
    let emulator = run(0x0f, 0x01);
...
fn test_add_zeroed(run: fn(a: u8, b: u8) -> Emulator) {
